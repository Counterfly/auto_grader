...
import assignment.test_cases as test_cases_module


# CONSTANTS
DEFAULT_ASSIGNMENT_NUM = 2 # Assignment wanting to grade (default if not specified)
...
FILENAME_TEST_CASES = "test_cases.py"
...
def main(argv):
    '''Grades the assignment specified at the input arugment.
    '''
